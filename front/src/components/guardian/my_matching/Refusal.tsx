export default function Refusal() {
  ...
  return (
    <div className="max-tablet:flex max-tablet:w-full max-tablet:flex-grow max-tablet:flex-col max-tablet:mt-[34px] max-tablet:pb-[30px]">
      <strong className="max-tablet:block max-tablet:text-left max-tablet:ml-[26px] max-tablet:text-[26px] max-tablet:font-[700] max-tablet:text-[#000000] max-tablet:leading-[31px]">{`거절한 요청이 ${matching.length}건 있어요`}</strong>
