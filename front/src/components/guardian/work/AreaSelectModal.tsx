...
export default function AreaSelectModal({
  ...
  return (
    <div className="fixed inset-0 bg-white z-50 ">
      ...
      <div>
        <div className="overflow-y-auto h-[689px] flex border-t border-b border-[#666666]">
          <div className="flex-1 border-r border-[#666666]  overflow-y-auto text-[18px] font-medium text-center">
            <div className="leading-[109px]  text-center bg-[#F7F8FA] border-b border-[#666666]">
              시/도
            </div>
        ...
        <div className="fixed flex-col bottom-0 left-0 right-0 flex  border-t border-[#666666] bg-white">
          <div className="p-[15px_24px] bg-[#F7F8FA]">
            <p className="text-[18px] text-black">
              <span className="text-key">최대 10개</span>까지 선택할 수 있어요.
            </p>
